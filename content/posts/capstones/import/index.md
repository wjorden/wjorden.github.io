...
``` python
# since we know that year has a few notes in addition, we can use the total rows of the pulses for the ending
all_years=df['Year'].iloc[0:53]
all_dry_edible=df['All dry edible beans'].iloc[0:53]
```
