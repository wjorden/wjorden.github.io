...
tags: ["R", "ggplot", "python", "statistics"]
---
...
```
    ...
    ## Index(['Year ', 'Black', 'Blackeye', 'Garbanzo', 'Great northern',
    ##        'Lima, all ', 'Lima, baby ', 'Lima, large', 'Navy ', 'Pink', 'Pinto',
    ##        'Red kidney, all ', 'Red kidney, dark ', 'Red kidney, light ',
    ##        'Small red', 'Other/2', 'All dry edible beans',
    ##        'Total, less garbanzo '],
    ##       dtype='object')

While trying to access the Year column, pandas kept throwing “KeyError: ‘Year’”. Something not noticed in the sheet… There is a trailing whitespace on the column name. using the df.keys() function, allows us to see all of the column names in raw format. Now we can strip the white space.
...
And just like that, it’s all nice and whitespace free.
